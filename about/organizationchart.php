...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Gamako | About | Organization Chart</title>
            ...
            <div class="main-container">
                ...
                <div class="main-content">
                    ...
                    <div class="aside about">
                        <a href="<?php echo $prefix;?>about/history.php">
                            <div>History</div>
                        </a>
                        <a class="selected" href="<?php echo $prefix;?>about/organizationchart.php">
                    ...
                    <div class="inner-content news-events">
                        ...
                        <div style="margin-bottom: 20px">
                            <h2>About <span>/ Organization Chart</span></h2>
                            <div class="red-line"></div>
                        </div>
                        
                        <img src="../img/uploads/about/organization-structure.jpg" width="600" style="display:block; margin: auto">
